// https://github.com/raspberrypi/pico-examples/tree/master/usb/device/dev_multi_cdc
...
# define CDC_VID    0x2E8A
// use _PID_MAP to generate unique PID for each interface
// #define CDC_PID     (0x4000 | _PID_MAP(CDC, 0))
#define CDC_PID     0x000A
// set USB 2.0
...
tusb_desc_device_t const desc_device = {
    ...
    .bDeviceSubClass = 0x02, // Abstract Control Model (ACM)
    .bDeviceProtocol = 0x01, // AT commands (V.25ter)
...
char const *string_desc_arr[] = {
    ...
    "skyaddlol",                    // 1: Manufacturer
    "clock",                        // 2: Product
    "ABCDEFGH12345678",             // 3: Serial
